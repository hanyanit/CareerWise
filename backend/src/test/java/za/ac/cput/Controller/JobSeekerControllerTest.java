...
class JobSeekerControllerTest {
    ...
    void create() {
        ...
        assertNotNull(testJobSeeker.getEmail());
    ...
    void update() {
        ...
        JobSeeker updatedJobSeeker = new JobSeeker.JobSeekerBuilder(
                testJobSeeker.getUserId(),
                testJobSeeker.getEmail(),
                testJobSeeker.getPassword()
        )
                .firstName("Inga Updated")
                .lastName("Mbobo Updated")
                ...
                .resumePath("inga_resume_updated.pdf")
                .build();
